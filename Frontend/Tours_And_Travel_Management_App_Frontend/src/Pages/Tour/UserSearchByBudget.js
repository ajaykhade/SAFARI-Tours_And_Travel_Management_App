...
const UserSearchByBudget = () => {
  const [Tours, setTours] = useState([]);
  const user = sessionStorage.getItem("userId");
  const uID = user ?? ' '

  const init = () => {
    TourServices.getByBudget()
      .then(response => {
        ...
        return (
          <div className="container-fluid" style={Styles.divStyle}>
            <div style={{ padding: "5px", width: "80%" }}>
              ...
              <hr />
              <h2 style={{ fontFamily: "Uchen, serif" }}>
                {tour.tourName} package
              </h2>
              <p>
              ...
              <h5 style={{ fontFamily: "Uchen, serif" }}>
                {" "}
              ...
              <p>
                Start Date :&nbsp;&nbsp;<b>{tour.tourStartDate}</b>&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;End Date :
...
export default UserSearchByBudget